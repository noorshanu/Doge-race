function Hero() {
  return (
    <section className="relative z-10 overflow-hidden bg-[#424242]">
      <div className="container-wrapper lg:h-full flex flex-col items-center justify-center pt-6 pb-12 lg:pt-0 lg:pb-0 lg:drop-shadow-[0_0_10rem_white]">
        ...
        <div className=" text-center mt-4 sm:mt-0">
          <h1 className="text-center text-[#ffffff] text-2xl sm:text-3xl lg:text-4xl font-dream uppercase pb-2  max-w-4xl mx-auto"> SolSon  - Solana's True child in Simpson Memes! </h1>
